 ...
 *}
 ...
 <div id="add-to-wislist-modal" class="wishlist-modal modal fade" tabindex="-1" role="dialog" aria-labelledby="addToWishlistModalTitle" aria-hidden="true" data-add-wishlist-url="{$addUrl}">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="addToWishlistModalTitle">{$wishlistsTitlePage}</h5>
